...
document.querySelector('#submit').addEventListener('click', function(){
    const listItems = document.querySelectorAll('textarea');
    const aryItems = [...listItems];
    combineLists(aryItems);
});
...
function combineLists(ary) {
    ...
    document.querySelector('#AllItems').innerHTML = str.toLocaleString()
    };
